        ...
        <div class="col-md-6">
          <div class="panel panel-default">
            <div class="panel-body">
              <tr>
                <td width="540" height="20"><h4 class ="h4__subtitles">1. Sucursal donde sucedió el hecho</h4></td>
                </tr>
                <table>
                  <tr>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='form-group'>
                      <input class='form-control'  name='correo' type='text' value='$correo' readonly='readonly' >
                            ...
                            <tr>
                <td width="540" height="20"><h4 class ="h4__subtitles">2. Identificación del Cliente:</h4></td>
                </tr>  
                      ...
                      <div class="col-md-6">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                            ...
                            <tr>
                                  <td width="540" height="20"><h4 class ="h4__subtitles">3. Identificación del Bien Contratado:</h4></td>
                              </tr>
                              <!--
                              <table>      
                                      <tr>
...
alert("Por Favor, el comentario no debe exceder de 500 caracteres");
                                ...
                                <tr>
                                  <td width="50" height="50"><h4 class ="h4__subtitles">4. Detalle del reclamo y pedido del consumidor:</h4></td>
